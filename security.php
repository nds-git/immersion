...
<body>
    ...
    <main id="js-page-content" role="main" class="page-content mt-3">
        ...
        <form action="/c/edit-pr-user.php" method="POST" >
         <?php 
            ...
            <div class="row">
                ...
                <div class="panel-content">
                    ...
                    <div class="form-group">
                     ...
                     <input type="text" id="simpleinput" class="form-control" value="<?=$pr['email']?>" name="email">
                    </div>
                    <!-- status -->
                    <div class="form-group">
                    ...
                    <input type="hidden" class="form-control border-left-0 bg-transparent pl-0" value="<?=$pr['user_id']?>" name = "user_id" />

                    <div class="col-md-12 mt-3 d-flex flex-row-reverse">
                        <button type="submit" name="edit_user" class="btn btn-warning">Изменить</button>
                    </div>
                </div>
                </div>
